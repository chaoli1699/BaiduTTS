...
public class MiniActivity extends Activity {
    ...
    private static final String TEXT2 = "Thank you for using 百度  voice syntherizer, please change the testing text in your code.";
    ...
    private void speak() {
        ...
        mShowText.setText("");
        print("合成并播放 按钮已经点击");
        int result = mSpeechSynthesizer.speak(TEXT2);
